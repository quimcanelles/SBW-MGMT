...
#' 
#' @case.example
#' data(landscape);source("R/default.params.r");load("data/default.tables.rda")
#' land=landscape[runif(10,1,nrow(landscape)),]; params = default.params(); tbls=default.tables
